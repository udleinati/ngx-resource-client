(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('util'), require('rxjs'), require('dexie'), require('@nguniversal/express-engine/tokens'), require('rxjs/operators'), require('lodash')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', 'util', 'rxjs', 'dexie', '@nguniversal/express-engine/tokens', 'rxjs/operators', 'lodash'], factory) :
	(factory((global['ngx-jsonapi'] = {}),global.ng.core,global.common,global.http,global.util,global.rxjs,global.Dexie,global.tokens,global.operators,global.lodash));
}(this, (function (exports,core,common,http,util,rxjs,Dexie,tokens,operators,lodash) { 'use strict';
